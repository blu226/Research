...
def create_new_constants_file(day, V, T, directory, time):
    ...
    NoOfDMs = V - 9
    link_exists = "Link_Exists_path = '../Bands_UMass" + str(20) + "/" + directory + "Day2/" + "\'\n"
    ...
    message_line = "generated_messages_file = \'../Bands_UMass" + str(20) + "/" + str(directory) + "Day1/generated_messages.txt\'\n"
...
for i in range(len(directorys)):
    ...
    # v = len(files)
    for v in range(21, 9, -2):
        run_simulation_files(2,v, 240, directorys[i], 0)