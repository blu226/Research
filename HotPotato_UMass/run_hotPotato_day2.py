...
def create_new_constants_file(day, V, T, directory, time):
    ...
    metrics_file_name = "metrics_file_name = \"metrics_LLC_day" +str(day) + "_HP.txt\"\n"
...
def run_simulation_files(day, V, T,directory,time):
    ...
    for ind in run:
        ...
        path_to_folder = path_to_folder + "HotPotato/" + str(V - 9) + "/"
...
for i in range(len(directorys)):
    ...
    run_simulation_files(2,v-4,120, directorys[i], 0)