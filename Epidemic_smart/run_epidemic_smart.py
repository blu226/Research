...
for max_mules in mule_set:
    for run in range(run_start_time, 4):
        ...
        S = [0, 1, 2, 3]
        path_to_folder = "../Bands" + str(max_mules) + "/" + str(run) + "/Day1/ALL/EpidemicSmart/"
        ...
        with open("constants.py", "w") as f:
            ...
            f.write("delivery_file_name = " + '"delivery_epidemic_smart_day1.txt"' + "\n")
            f.write("metrics_file_name = " + '"metrics_epidemic_smart_day1.txt"' + "\n")
