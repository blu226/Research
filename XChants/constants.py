...
V = 37
NoOfDMs = 25
path_to_folder = '../Bands25/1/Day1/ALL/XChants/'
S = [0, 1, 2, 3]
lex_data_directory = '../Lexington25/1/'
lex_data_directory_day = '../Lexington25/1/Day1/'
...
wait_time = [2, 7]
run_start_time = 1
pkl_folder = '../Lexington25/1/Day1_pkl/'
validate_pkl_folder = '../Lexington25/1/Day1_pkl/'
