...
wait_time = [2, 5]
run_start_time = 1
pkl_folder = '../Lexington15/3/Day1_pkl/'
validate_pkl_folder = '../Lexington15/3/Day1_pkl/'
path_to_folder = '../Bands15/3/Day1/ALL/'
S = [0, 1, 2, 3]
validate_data_directory = '../Lexington15/3/Day1/'
lex_data_directory = '../Lexington15/3/'
lex_data_directory_day = '../Lexington15/3/Day1/'
