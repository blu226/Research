...
consumedEnergyFile = 'energy_metrics.txt'
consumedEnergyFile = 'energy_metrics.txt'
validate_data_directory = '../Lexington25/1/Day1/'
consumedEnergyFile = 'energy_metrics.txt'
consumedEnergyFile = 'energy_metrics.txt'
consumedEnergyFile = 'energy_metrics.txt'
max_nodes = 30
...
V = 37
NoOfDMs = 25
path_to_folder = '../Bands25/1/Day2/ALL/XChants/'
S = [0, 1, 2, 3]
lex_data_directory = '../Lexington25/1/'
lex_data_directory_day = '../Lexington25/1/Day2/'
link_exists_folder = '../Bands25/1/Day2/'
...
wait_time = [2, 7]
run_start_time = 1
pkl_folder = '../Lexington25/1/Day2_pkl/'
validate_pkl_folder = '../Lexington25/1/Day2_pkl/'
consumedEnergyFile = 'energy_metrics.txt'
